...
NUM_JOBS=12  # number of jobs to run in parallel, may need to reduce to satisfy computational constraints

python -u abides.py -c rmsc03 -t ABM -d 20200603 -s 9234  -l rmsc03_two_hour
